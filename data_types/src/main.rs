fn main() {
    ...
    // let new_name = name.replace("Ton", "T");
    ...
    // let str1 = "hello"; // contains address, actual data and length. Cannot be modified
    ...
    // // String literals use when we dont want valid utf8
